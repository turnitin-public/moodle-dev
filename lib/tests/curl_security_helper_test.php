...
class core_curl_security_helper_testcase extends advanced_testcase {
    ...
    public function test_curl_security_helper_get_blocked_url_string() {
        $this->assertEquals(get_string('curlsecurityurlblocked', 'admin'), \core\curl\curl_security_helper::get_blocked_url_string());
    }

    /**
     * Test for the protected function \core\curl\curl_security_helper::parse_url().
     *
     ...
     *
     */
    public function test_curl_security_helper_parse_url($url, $expected) {
        $this->assertEquals($expected, phpunit_util::invoke_static_method('core\\curl\\curl_security_helper', 'parse_url', [$url]));
    }

    /**
     * Data provider for test_curl_security_helper_parse_url.
     *
     * @return array
     */
    public function curl_security_parse_url_data_provider() {
        return [
