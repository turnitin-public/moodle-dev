 ...
 */
function enrol_lti_verify_private_key($record) {
    ...
    if (empty($key)) {
        ...
        if (!empty($privatekey)) {
            set_config('privatekey_'.$record->id, $privatekey, 'enrol_lti');
        } else {
            // TODO: Make a string in enrol/lti/lang/en/
            return "OpenSSL configuration is invalid, can't create keys";
