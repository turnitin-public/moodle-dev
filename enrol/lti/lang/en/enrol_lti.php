...
$string['endpointltiversionnotice'] = 'The tool endpoints below are for manual LTI 1.3 setup only. For earlier versions (1.1/2.0), details for consumers can be found on the \'Published as LTI tools\' page in the course administration.';
...
$string['existingregistrationerror'] = 'A registration already exists for this issuer.';
...
$string['registerplatform:duplicateplatformiderror'] = 'Invalid Platform Id. This Platform Id is already registered.';
...
$string['registrationdeeplinklabel'] = 'Add content from Moodle';
$string['registrationresourcelinklabel'] = 'Launch content from Moodle';
...
$string['registrationurlinfomessage'] = 'For platforms supporting LTI Advantage Dynamic Registration, you can generate a one-time registration URL
            here. More information on dynamic registration can be found on the <a href="https://docs.moodle.org/311/en/Publish_as_LTI_tool">Publish as LTI tool docs page</a>';
