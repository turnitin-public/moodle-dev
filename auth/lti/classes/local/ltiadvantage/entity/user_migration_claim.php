...
/**
 * A simplified representation of a 'https://purl.imsglobal.org/spec/lti/claim/lti1p1' migration claim, for the purpose
 * of migrating a legacy user account only. Claim properties that do not relate to user migration are not handled.
 *
