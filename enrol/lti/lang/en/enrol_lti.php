...
$string['adddeployment:deploymentid_help'] = 'Each deployment of the Moodle tool in a platform will be issued with a Deployment ID that is unique to the registration. This must be registered with Moodle before launches from the respective tool deployment are allowed.';
...
$string['endpointltiversionnotice'] = 'The tool endpoints below are for LTI 1.3 setup only. For earlier versions, details for consumers can be found on the \'Published as LTI tools\' page in the course administration.';
...
$string['lti13launchdetails_help'] = 'The launch URL and custom properties are only required when manually configuring a resource link in the platform. Where possible, instructors should favour the content selection (deep linking) process for the creation of resource links.';
...
$string['nopublishedresources'] = 'No resources are published yet';
...
$string['publishedresources'] = 'Published resources';
$string['publishedresources_help'] = 'A published resource is shared with registered platforms via the content selection (deep linking) flow. Additionally, a resource link can be created in the platform by using the launch url and the custom params provided.';
...
$string['privacy:metadata:enrol_lti_user_resource_link'] = 'A map of enrol_lti_user records to resource_link records';
$string['privacy:metadata:enrol_lti_user_resource_link:userid'] = 'The ID of the lti user record';
$string['privacy:metadata:enrol_lti_user_resource_link:resourcelinkid'] = 'The ID of the resource link record';
...
$string['registerplatform:duplicateclientiderror'] = 'Invalid Client Id. This Client Id is already registered for this Platform Id.';
...
$string['registeredplatformname'] = '{$a->name} ({$a->platformid})';
