...
/**
 * Unit test for delete_tool_proxy external function.
 *
 * @coversDefaultClass \core_ltix\external\delete_tool_proxy
 * @package    core_ltix
 * @copyright  2024 Jake Dallimore <jrhdallimore@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class delete_tool_proxy_test extends lti_testcase {
    ...
    public function test_delete_tool_proxy(): void {
        ...
        $proxy = delete_tool_proxy::execute($proxy->id);
        $proxy = (object) external_api::clean_returnvalue(delete_tool_proxy::execute_returns(), $proxy);
