...
class provider_test extends provider_testcase {
    ...
    public function test_delete_data_for_users_course() {
        ...
        $approveduserlist = new \core_privacy\local\request\approved_userlist($coursecontext, 'enrol_lti', [$this->user->id]);
    ...
    public function test_delete_data_for_users_activity() {
        ...
        $approveduserlist = new \core_privacy\local\request\approved_userlist($cmcontext, 'enrol_lti', [$this->user->id]);
        provider::delete_data_for_users($approveduserlist);
