...
abstract class core_filetypes {
    ...
    protected static function get_default_types() {
        return array(
            ...
            'mka' => array('type' => 'audio/x-matroska', 'icon' => 'audio', 'groups' => array('audio'), 'string' => 'audio'),
            'mkv' => array('type' => 'video/x-matroska', 'icon' => 'video', 'groups' => array('video'), 'string' => 'video'),
            'mk3d' => array('type' => 'video/x-matroska-3d', 'icon' => 'video', 'groups' => array('video'), 'string' => 'video'),
