...
/**
 * Strings for component 'ltixservice_memberships', language 'en'
 *
...
$string['ltixservice_memberships'] = 'IMS LTI Names and Role Provisioning';
$string['ltixservice_memberships_help'] = 'Allow the tool to retrieve members\' info from the course using the IMS LTI Names and Role Provisioning Service. The privacy settings will apply. For course-level requests these will be based on the tool configuration settings. If you wish to always send such details, do not delegate the choice to teachers. Link-level requests will always use the privacy settings which apply to the link.';
