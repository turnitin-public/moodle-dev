...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2016072800.01) {
        ...
        // Define a field 'deletioninprogress' in the 'course_sections' table. To background deletion tasks.
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2016072800.01);
    }
