...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2018101100.01) {
        ...
        $table->add_field('itemid', XMLDB_TYPE_CHAR, '10', null, XMLDB_NOTNULL, null, null);
        ...
        // Add composite index 'favouriteitem' to the table 'favourite'.
        $index = new xmldb_index('uniqueuserfavouriteitem', XMLDB_INDEX_NOTUNIQUE,
