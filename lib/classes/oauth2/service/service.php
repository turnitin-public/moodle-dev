...
abstract class service {
     ...
     * They must provide a subclass of {@see config}.
     *
    ...
    /**
     * Static factory method to return an instance of the service given an issuer.
     *
     * Service plugins should validate the issuer as part of implementing this method (or, more naturally, as part of their
     * constructor code).
     *
    ...
    /**
     * Factory to get an instance from formdata.
     * @param \stdClass $data
     * @return service
     */
    public static function get_from_formdata(\stdClass $data): service {
        $id = $data->id ?? 0;
        $issuer = new issuer($id, $data);
        return static::get_instance($issuer);
    }

    /**
     * Chance for plugins to validate the issuer form data and return any plugin-specific errors.
     *
     * @param array $coreerrors the array of errors generated by core form validation.
     * @return array the errors array, e.g. ['errors' => 'formfield']
     */
