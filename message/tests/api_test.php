...
class core_message_api_testcase extends core_message_messagelib_testcase {
    ...
    public function test_get_favourite_conversations() {
        ...
        $conversations = \core_message\api::get_favourite_conversations($user1->id);
    ...
    public function test_get_favourite_conversations_limit_offset() {
        ...
        $this->assertCount(2, \core_message\api::get_favourite_conversations($user1->id, 1, 10));
        ...
        $this->assertCount(0, \core_message\api::get_favourite_conversations($user1->id, 4, 10));
    }
    ...
    public function test_set_favourite_conversation() {
        ...
        $this->assertCount(0, \core_message\api::get_favourite_conversations($user2->id));
    ...
    public function test_unset_favourite_conversation() {
        ...
        $this->assertCount(1, \core_message\api::get_favourite_conversations($user1->id));
        $this->assertCount(1, \core_message\api::get_favourite_conversations($user3->id));
        ...
        $this->assertCount(1, \core_message\api::get_favourite_conversations($user3->id));
        $this->assertCount(0, \core_message\api::get_favourite_conversations($user1->id));
