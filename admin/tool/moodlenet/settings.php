...
if ($hassiteconfig) {
    ...
    $temp = new admin_setting_configtext('tool_moodlenet/defaultmoodlenetname', get_string('defaultmoodlenetname', 'tool_moodlenet'),
        new lang_string('defaultmoodlenetname_desc', 'tool_moodlenet'), 'Moodle HQ MoodleNet');
    $settings->add($temp);
