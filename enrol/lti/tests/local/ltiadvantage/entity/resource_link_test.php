...
class resource_link_test extends \advanced_testcase {
    ...
    public function test_add_user() {
        ...
        $user = $reslinkwithid->add_user(new \moodle_url('https://platform.example.com'), 'platform-user-id-123',
            'Test', 'Student', 'en', 's1@example.com', 'Sydney', 'AU', 'Test university', '99');
        ...
        $reslinkwithoutid->add_user(new \moodle_url('https://platform.example.com'), 'platform-user-id-123', 'Test',
            'Student', 'en', 's1@example.com', 'Sydney', 'Australia', 'Test university', '99');
    }
