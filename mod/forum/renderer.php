...
class mod_forum_renderer extends plugin_renderer_base {
     ...
     *
     * @param \mod_forum\output\activity_actionbar $actionbar activity_actionbar object.
     * @return string rendered HTML string
     */
    public function render_activity_actionbar(\mod_forum\output\activity_actionbar $actionbar):string {
