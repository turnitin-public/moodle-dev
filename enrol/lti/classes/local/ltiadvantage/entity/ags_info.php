...
/**
 * Contains the ags_info class, used to validate service information associated with a resource_link.
 *
 * @package    enrol_lti
...
\     */
     ...
     */
    public static function create(\moodle_url $lineitemsurl, ?\moodle_url $lineitemurl = null, array $scopes = []) {
