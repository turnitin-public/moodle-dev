...
class admin_setting_configmixedhostiplist extends admin_setting_configtextarea {
    ...
    protected function ace_encode($data) {
        ...
        foreach ($entries as $key => $entry) {
            ...
            // d) contains a-zA-Z0-9, hyphen, dot and any non-ascii unicode characters in the middle.
    ...
    public function write_setting($data) {
        ...
        // Convert any non-ascii domains to ACE prior to validation - we can't modify anything in validate!
