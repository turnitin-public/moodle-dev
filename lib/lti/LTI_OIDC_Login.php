...
class LTI_OIDC_Login {
    ...
    public function do_oidc_login_redirect($launch_url, array $request = null) {
        ...
        $auth_login_return_url = $registration->get_auth_login_url() . "?" . http_build_query($auth_params, null, '&');

        // Return auth redirect.
        return new Redirect($auth_login_return_url, http_build_query($request, null, '&'));
