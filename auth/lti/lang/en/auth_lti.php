...
$string['accountlinkedsuccess'] = 'Your exising account has been successfully linked.';
...
$string['firstlaunchnoauthnotice'] = 'To link your existing account you must be logged in to the site. Please log in to the site in a new tab/window and then relaunch the tool here. For further information, see the documentation <a href="https://docs.moodle.org/en/Publish_as_LTI_tool">Publish as LTI tool</a>.';
