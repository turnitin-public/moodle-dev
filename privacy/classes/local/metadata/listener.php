...
/**
 * Contains the interface for privacy metadata listeners.
 *
...
/**
 * Interface describing privacy metadata listeners.
 *
 * Metadata listeners are informed of metadata changes, and may include (but are not limited to) auditing and reporting admin tools.
 *
 * @copyright 2018 Jake Dallimore <jrhdallimore@gmail.com>
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
