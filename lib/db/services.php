...
$functions = array(
    ...
    'core_message_get_favourite_conversations' => array(
        'classname' => 'core_message_external',
        'methodname' => 'get_favourite_conversations',
        'classpath' => 'message/externallib.php',
        'description' => 'Get the list of conversations marked as favourite/starred conversations.',
        'type' => 'read',
        'services' => array(MOODLE_OFFICIAL_MOBILE_SERVICE),
    ),
