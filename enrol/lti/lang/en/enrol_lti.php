...
$string['registerplatform:invalidplatformiderror'] = 'Invalid Platform Id. This URL is already registered.';
...
$string['registerplatformdeleteconfirm'] = 'Are you sure you want to delete the registration for the platform \'{$a}\'?';
