...
export const init = (elementId) => {
    ...
    for (let key in FIELDS) {
        ...
        if (element) {
            ...
            element.addEventListener('input', eventHandler.bind(null, fieldInfo, parentElement, allParentElements), false);
        }
    }
};

const eventHandler = (fieldInfo, parentElement, allParentElements, event) => {
