...
if ($hassiteconfig) { // speedup for non-admins, add all caps used on this page
    ...
    // Settings elements used by the \core\curl_security class.
    $temp->add(new admin_setting_configmixedhostiplist('curlsecurityblockedhosts', new lang_string('curlsecurityblockedhosts', 'admin'),
        new lang_string('curlsecurityblockedhostssyntax', 'admin'), ""));
    $temp->add(new admin_setting_configportlist('curlsecurityallowedport', new lang_string('curlsecurityallowedport', 'admin'),
