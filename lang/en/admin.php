...
$string['curlblacklist'] = 'cURL security';
$string['curlblacklistallowedport'] = 'cURL allowed ports list';
$string['curlblacklistallowedportsyntax'] = 'Put every entry on one line. Valid entries are integer numbers only.';
$string['curlblacklistblockedip'] = 'cURL blocked IP list';
$string['curlblacklistblockedipsyntax'] = 'Put every entry on one line. Valid entries are either full IP address (such as <b>192.168.10.1</b>) which matches a single host; or partial address (such as <b>192.168.</b>) which matches any address starting with those numbers; or CIDR notation (such as <b>231.54.211.0/20</b>); or a range of IP addresses (such as <b>231.3.56.10-20</b>) where the range applies to the last part of the address. Text domain names (like \'example.com\') are not supported. Blank lines are ignored.';
$string['curlblacklistenable'] = 'Enable cURL host/port restrictions';
$string['curlblacklistenabledesc'] = 'Check to enable host/port restrictions on outbound cURL requests.';
$string['curlblacklistipblocked'] = 'The host {$a} is blocked.';
$string['curlblacklistportblocked'] = 'The port {$a} is blocked.';
$string['curlblacklisturlblocked'] = 'The URL is blocked.';
$string['curlblacklisturlparseiperror'] = 'Could not resolve host IP address.';
$string['curlblacklisturlparseporterror'] = 'Could not resolve host port number.';
