...
/**
 * Unit tests for the Mustache source loader class (contains logic about
...
TBC;
        ...
        $this->assertEquals(trim($templatebody), trim($loader->strip_template_comments($templatewithcomment)));
    }

    /**
     * Data provider for the test_load_from_full_name function.
     */
    public function test_load_from_full_name_test_cases() {
        $cache = [
            'core' => [
    ...
    /**
     * Test the load_from_full_name function.
     *
     * @dataProvider test_load_from_full_name_test_cases()
     ...
     */
    public function test_load_from_full_name($loader, $fullname, $includecomments, $expected) {
        $this->assertEquals($expected, $loader->load_from_full_name($fullname, 'boost', $includecomments));
    }
    ...
    public function test_scan_template_source_for_dependencies($loader, $source, $expected) {
        $actual = $loader->scan_template_source_for_dependencies($source);
        $this->assertEquals($expected, $actual);
    }
