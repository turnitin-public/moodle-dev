...
M.form_filemanager.init = function(Y, options) {
    ...
    Y.extend(FileManagerHelper, Y.Base, {
        ...
        initializer: function(options) {
            ...
            this.raceconditioncheck = options.raceconditioncheck;
            ...
            var cfg = {
                ...
                on: {
                    complete: function(id,o,p) {
                        ...
                        if (data && data.originalmodified && scope.raceconditioncheck) {
                            scope.print_msg(M.util.get_string('externalchange', 'repository'), 'error');
                        }
