...
$PAGE->set_url('/oauth2/issuers.php');
...
if ($mform && $mform->is_cancelled()) {
    ...
    if (!optional_param('confirm', false, PARAM_BOOL)) {
        ...
        $continueurl = new moodle_url('/oauth2/issuers.php', $continueparams);
        $cancelurl = new moodle_url('/oauth2/issuers.php');
        echo $OUTPUT->header();
    ...
    if (!optional_param('confirm', false, PARAM_BOOL)) {
        ...
        if (core\oauth2\api::connect_system_account($issuer, new moodle_url('/oauth2/issuers.php', $params))) {
    ...
    // Generic issuer.
    $addurl = new moodle_url('/oauth2/issuers.php', ['action' => 'edit']);
