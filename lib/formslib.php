...
class MoodleQuickForm_Renderer extends HTML_QuickForm_Renderer_Tableless{
     ...
     * TODO MDL-58427 deprecate this when clean (and bs2 based) theme support ends.
     *
     * @param \HTML_QuickForm_element $element the element to be checked.
     *
     */
