...
$string['registrationtype_help'] = 'Manual registration involves manually configuring the tool in the platform, and subsequently recording details about the platform in this site.<br><br>Dynamic registration simplifies the process, but is optional in LTI Advantage and may not be supported by all platforms.<br><br>For further information, see the documentation <a href="{$a}">Publish as LTI tool</a>.';
$string['registrationurl'] = 'Registration URL';
$string['registrationurlinfomessage'] = 'For platforms supporting LTI Advantage Dynamic Registration, you can copy the registration URL
