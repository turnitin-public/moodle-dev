...
if (typeof M.form.dependencyManager === 'undefined') {
    ...
    Y.extend(dependencyManager, Y.Base, {
        ...
        checkDependencies: function(e, dependon) {
            window.console.log('in check dependencies');
         ...
         */
        updateForm: function() {
            window.console.log('in updateForm', this);
            var el;
        ...
        _disableElement: function(name, disabled) {
            window.console.log('setting '+name, disabled); // test.
            ...
            els.each(function(node) {
                window.console.log('found node', node);
                if (disabled) {
