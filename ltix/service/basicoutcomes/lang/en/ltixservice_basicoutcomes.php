...
/**
 * Strings for component 'ltixservice_basicoutcomes', language 'en'
 *
...
$string['ltixservice_basicoutcomes'] = 'Basic Outcomes';
$string['ltixservice_basicoutcomes_help'] = 'Allow the tool to save and retrieve its grades to a gradebook column associated with each link.';
