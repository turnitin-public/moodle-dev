...
$string['completion-alt-auto-n-override'] = 'Not completed: {$a->modname} (override by {$a->overrideuser})';
$string['completion-alt-auto-pass'] = 'Completed: {$a} (achieved pass grade)';
$string['completion-alt-auto-y'] = 'Completed: {$a}';
$string['completion-alt-auto-y-override'] = 'Completed: {$a->modname} (override by {$a->overrideuser})';
...
$string['completion-alt-manual-n-override'] = 'Not completed: {$a->modname} (override by {$a->overrideuser}. Select to mark as complete.';
