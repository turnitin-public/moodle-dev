...
class curl {
     ...
     *  securityhelper: (\core\curl\curl_security_helper_base) helper object providing URL checking for requests.
    ...
    public function __construct($settings = array()) {
        ...
        if (isset($settings['securityhelper']) && $settings['securityhelper'] instanceof \core\curl\curl_security_helper_base) {
            $this->set_security($settings['securityhelper']);
        } else {
            $this->set_security(new \core\curl\curl_security_helper());
        }
     ...
     *
     * @return \core\curl\curl_security_helper instance.
     */
     ...
     *
     * @param \core\curl\curl_security_helper $securityobject instance/subclass of the base curl_security_helper class.
     * @return bool true if the security helper could be set, false otherwise.
     */
    public function set_security($securityobject) {
        if ($securityobject instanceof \core\curl\curl_security_helper) {
